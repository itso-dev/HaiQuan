...
<div class="head-wrap">
    <span><?= $row['name'] ?>님 상담내역</span>
    <i class="fas fa-times modal-close" data-dismiss="modal" id="modal-close"></i>
</div>
<form name="madal_form" class="body" id="madal_form" method="post" action="./ajax/contact_insert.php">
    ...
    <div>
        <div class="input-wrap">
            <label for="modal_counsel_content_result" class="label">결과</label>
    ...
    <div class="input-wrap">
        <label for="counsel_content_body" class="label">상담내용</label>
        <textarea name="contact_desc" class="modal-textarea"><?= $row['counsel_desc'] ?></textarea>
    </div>
    <div class="btn-wrap mt-3">
        <!-- <button type="button" class="btn btn-secondary" data-dismiss="modal" id="modal-close">닫기</button> -->
        <input type="submit" class="submit btn btn-primary w-100" value="저장"></button>
    </div>
</form>
