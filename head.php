...
<body>
    <div id="header">
        ...
        <nav>
            <ul>
                <li class="link" data-target="page2">검증된 매출</li>
                <li class="link" data-target="page4">고객&점주이야기</li>
                <li class="link" data-target="page10">창업안내</li>
                <li class="link" data-target="contact">창업문의</li>
            </ul>
        </nav>
        <a href="tel:024988757" class="call">
    ...
    <div class="mo-menu">
        ...
        <div class="mo-menu-bottom">
            ...
            <a href="tel:16618466" class="call">
                <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 26 26" fill="none">
...
<script>
    ...
    $(document).ready(function () {
        ...
        function checkActivemenu() {
            ...
            menuOffsets = {
                'page2': $('#page2').offset().top - 100,
                'page4': $('#page4').offset().top - 100,
                'page10': $('#page10').offset().top - 100,
