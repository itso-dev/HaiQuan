...
<footer>
    <div class="footer-big-container">
        <div class="footer-container">
            <img src="<?= $site_url ?>/img/head-logo.png" class="footer-logo">
...
<div class="agree-modal">
    ...
    <div class="title">
        <img src="<?= $site_url ?>/img/head-logo.png" class="agree-logo">
